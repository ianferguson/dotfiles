# xrandr
# Autogenerated from man page /usr/X11/man/man1/xrandr.1.gz
...
complete -c xrandr -s q -l query --description 'When this option is present, or when no configu… [See Man Page]'
complete -c xrandr -l dryrun --description 'Performs all the actions specified except that … [See Man Page]'
...
complete -c xrandr -l current --description 'Return the current screen configuration, withou… [See Man Page]'
...
complete -c xrandr -l prop -l properties --description 'This option causes xrandr to display the conten… [See Man Page]'
...
complete -c xrandr -l dpi --description 'This also sets the reported physical size value… [See Man Page]'
complete -c xrandr -l newmode --description 'New modelines can be added to the server and th… [See Man Page]'
complete -c xrandr -o HSync -o VSync -o 'CSync.' --description 'tools permit to compute the usual modeline from… [See Man Page]'
...
complete -c xrandr -l auto --description 'For connected but disabled outputs, this will e… [See Man Page]'
complete -c xrandr -l mode --description 'This selects a mode.  Use either the name or the XID for mode.'
complete -c xrandr -l preferred --description 'This selects the same mode as --auto, but it do… [See Man Page]'
complete -c xrandr -l pos --description 'Position the output within the screen using pixel coordinates.'
complete -c xrandr -l rate --description 'This marks a preference for refresh rates close… [See Man Page]'
...
complete -c xrandr -l left-of -l right-of -l above -l below -l same-as --description 'Use one of these options to position the output… [See Man Page]'
complete -c xrandr -l set --description 'Sets an output property.'
complete -c xrandr -l off --description 'Disables the output.'
complete -c xrandr -l crtc --description 'Uses the specified crtc (either as an index in … [See Man Page]'
complete -c xrandr -l gamma --description 'Set the specified floating point values as gamm… [See Man Page]'
complete -c xrandr -l brightness --description 'Multiply the gamma values on the crtc currently… [See Man Page]'
complete -c xrandr -s s -l size -l size --description 'This sets the screen size, either matching by s… [See Man Page]'
complete -c xrandr -s r -l refresh --description 'This sets the refresh rate closest to the specified value.'
complete -c xrandr -s o -l orientation --description 'This specifies the orientation of the screen, a… [See Man Page]'
