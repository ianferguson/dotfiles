...
complete -c sdiff -s w -l width --description 'Output at most NUM (default 130) columns per line.'
...
complete -c sdiff -s H -l speed-large-files --description 'Assume large files and many scattered small changes.'
